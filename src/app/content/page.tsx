   ...
   return (
    <div className="pt-8 w-4/5 md:w-2/5">
       <section className="paragraph space-y-8">
        ...
        <p className="title">CONTENT I LIKE</p>
        
        <p>My favorites are highlighted in <span style={{ color: 'red' }}>red</span>.</p>
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            <Link href="https://en.wikipedia.org/wiki/Man%27s_Search_for_Meaning" target="_blank" rel="noopener noreferrer">Man's Search for Meaning (165 Pages)</Link>
          </li> */}

          {/* man's search for meaning */}
          <li>
            <Link href="https://en.wikipedia.org/wiki/Man%27s_Search_for_Meaning" target="_blank" rel="noopener noreferrer" style={{ textDecorationColor: 'red' }}><span style={{ color: 'red' }}>Man's Search for Meaning (165 Pages)</span></Link>
          </li>

          {/* the almanack of naval ravikant
          <li>
            <Link href="https://en.wikipedia.org/wiki/Naval_Ravikant" target="_blank" rel="noopener noreferrer">The Almanack of Naval Ravikant (164 Pages)</Link>
          </li> */}
          ...
          {/* rodger federer's commencement address */}
          <li>
          ...
          {/* ross mackay's open residency interview
          <li>
          ...
          {/* the mcgregor mentality */}
          <li>
            <Link href="https://open.spotify.com/show/2WerniSqZzakYUOpKMMXhW?si=206baa4efea14bae" target="_blank" rel="noopener noreferrer">The McGregor Mentality (15 Episodes)</Link>
          </li>
